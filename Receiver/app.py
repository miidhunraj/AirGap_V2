...
# ImportError/SyntaxError buried deep in a dependency. See
# requirements.txt for the verified-compatible range and why it's set
# where it is.
_MIN_PYTHON = (3, 8)
if sys.version_info < _MIN_PYTHON:
    sys.stderr.write(
        f"\n[AirGap] This receiver requires Python {_MIN_PYTHON[0]}.{_MIN_PYTHON[1]}+ "
